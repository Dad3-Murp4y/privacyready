...
# Forwards specific incoming emails to an SNS topic subscribed by all.datawai@gmail.com
...
resource "aws_sns_topic_subscription" "all_datawai" {
...
resource "aws_ses_receipt_rule_set" "main" {
  rule_set_name = "datawai-inbound-ruleset"
}

...
const pageProps = {
  ...
  cookies: {
    title: 'Cookie Policy | PrivacyReady',
    description: 'How PrivacyReady uses essential and optional analytics cookies and how to manage your preferences.',

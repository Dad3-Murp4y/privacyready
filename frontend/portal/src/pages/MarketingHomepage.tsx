...
export default function MarketingHomepage() {
  return <PublicSiteLayout title="PrivacyReady | Practical UK GDPR readiness" description="Scan observable website privacy signals and organise UK GDPR readiness work with PrivacyReady." canonicalPath="/">
    ...
    <section className="marketing-section" id="faq"><div className="marketing-section__header"><p className="eyebrow">Frequently asked questions</p><h2>Before you run your scan</h2></div><div className="faq-list">{PUBLIC_FAQS.slice(0, 4).map((faq) => <details key={faq.question}><summary>{faq.question}</summary><p>{faq.answer}</p></details>)}</div></section>
